...
if (save_plots) {
  ggsave(
  p,
  filename = "../plots/paper_figs/sr_30_step1_time.pdf", device = "pdf",
  height = 2, width = 4
  )
  }
...
if (save_plots) {
  ggsave(
    p,
    filename = "../plots/paper_figs/sr_30_step1_time_trial_set.pdf", device = "pdf",
    height = 2, width = 2
  )
}
...
```{r}
temp_ANOVA <- aov(mean_trial_set_step1_time ~ exp * trial_set, data = data_ppt)
...
```
```{r}
bf <- anovaBF(mean_trial_set_step1_time ~ exp * trial_set, data = data.frame(data_ppt), progress = FALSE)
print(bf)
bayesfactor_inclusion(bf)
```
...
if (save_plots) {
  ggsave(
  p,
  filename = "../plots/paper_figs/sr_30_step2_rt.pdf", device = "pdf",
  height = 2, width = 4
  )
  }
...
if (save_plots) {
  ggsave(
    p,
    filename = "../plots/paper_figs/sr_30_step2_rt_trial_set.pdf", device = "pdf",
    height = 2, width = 2
  )
}
...
```{r}
temp_ANOVA <- aov(mean_trial_set_step2_rt ~ exp * trial_set, data = data_ppt)
...
```
```{r}
bf <- anovaBF(mean_trial_set_step2_rt ~ exp * trial_set, data = data.frame(data_ppt), progress = FALSE)
print(bf)
bayesfactor_inclusion(bf)
```
...
if (save_plots) {
  ggsave(
  p,
  filename = "../plots/paper_figs/sr_30_step2_mt.pdf", device = "pdf",
  height = 2, width = 4
  )
  }
...
if (save_plots) {
  ggsave(
    p,
    filename = "../plots/paper_figs/sr_30_step2_mt_trial_set.pdf", device = "pdf",
    height = 2, width = 2
  )
}
...
```{r}
temp_ANOVA <- aov(mean_trial_set_step2_mt ~ exp * trial_set, data = data_ppt)
...
```
```{r}
bf <- anovaBF(mean_trial_set_step2_mt ~ exp * trial_set, data = data.frame(data_ppt), progress = FALSE)
print(bf)
bayesfactor_inclusion(bf)
```
